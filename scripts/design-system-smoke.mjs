...
const required = [
  ...
  [index.includes("export { MotionTreeNav }"), 'design-system index must export MotionTreeNav for reusable T1/T2 motion'],
  [index.includes("export { StickyMorphHeader }"), 'design-system index must export StickyMorphHeader for reusable sticky morph motion'],
  [index.includes("export { WorkbenchCard }"), 'design-system index must export WorkbenchCard for reusable T3 cards'],
  [index.includes("export { WorkbenchDetailPanel }"), 'design-system index must export WorkbenchDetailPanel for reusable T3 detail panels'],
  [index.includes("export { WorkbenchComposerPanel }"), 'design-system index must export WorkbenchComposerPanel for reusable T4 composer panels'],
  ...
  [page.includes('MotionTreeNav'), 'DesignSystem page must preview MotionTreeNav'],
  [page.includes('StickyMorphHeader'), 'DesignSystem page must preview StickyMorphHeader'],
  [page.includes('WorkbenchCard'), 'DesignSystem page must preview WorkbenchCard'],
  [page.includes('WorkbenchComposerPanel'), 'DesignSystem page must preview WorkbenchComposerPanel'],
  ...
  [tokens.includes('ds-sticky-morph-*'), 'tokens.md must document sticky morph motion tokens'],
  [tokens.includes('ds-workbench-*'), 'tokens.md must document workbench shell classes'],
  [components.includes('## `MotionTreeNav`'), 'components.md must document MotionTreeNav'],
  [components.includes('## `StickyMorphHeader`'), 'components.md must document StickyMorphHeader'],
  [components.includes('## `WorkbenchCard`'), 'components.md must document WorkbenchCard'],
  [components.includes('## `WorkbenchDetailPanel`'), 'components.md must document WorkbenchDetailPanel'],
  [components.includes('## `WorkbenchComposerPanel`'), 'components.md must document WorkbenchComposerPanel'],
